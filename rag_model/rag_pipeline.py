...
Your explanation:"""
    ...
    try:
        ...
        return (
            f"🔬 {test_name.title()}: {test_data['value']} {test_data['unit']} ({status})\n"
            "⚠️ Unable to generate AI explanation right now."
        )
...
However, I recommend consulting your healthcare provider who can give you personalized medical advice based on your specific situation."""
        ...
        try:
            ...
            # Enforce bullet format — if AI tries to return a paragraph, break it
            if "###" not in answer:
